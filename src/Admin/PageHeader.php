...
class PageHeader {
	...
	public static function render( string $current ): void {
		$pages = array(
			'infirewards'              => array( __( 'Overview', 'infirewards' ), 'dashicons-chart-area' ),
			'infirewards-earning-rule' => array( __( 'Earning Rules', 'infirewards' ), 'dashicons-admin-generic' ),
			'infirewards-rewards'      => array( __( 'Rewards', 'infirewards' ), 'dashicons-awards' ),
			'infirewards-customers'    => array( __( 'Customers', 'infirewards' ), 'dashicons-groups' ),
			'infirewards-settings'     => array( __( 'Settings', 'infirewards' ), 'dashicons-admin-settings' ),
		);
		?>
		<h1><?php esc_html_e( 'infiRewards', 'infirewards' ); ?></h1>
		<nav class="infirewards-page__nav" aria-label="<?php esc_attr_e( 'infiRewards pages', 'infirewards' ); ?>">
